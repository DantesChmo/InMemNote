...
DEFS_Debug := \
	'-DNODE_GYP_MODULE_NAME=window_events' \
	'-DUSING_UV_SHARED=1' \
	'-DUSING_V8_SHARED=1' \
...
OBJS := \
	$(obj).target/$(TARGET)/src/window_events.o
...
$(builddir)/window_events.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/window_events.node: LIBS := $(LIBS)
$(builddir)/window_events.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/window_events.node: TOOLSET := $(TOOLSET)
$(builddir)/window_events.node: $(OBJS) $(builddir)/nothing.a FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/window_events.node
# Add target alias
.PHONY: window_events
window_events: $(builddir)/window_events.node

# Short alias for building this executable.
.PHONY: window_events.node
window_events.node: $(builddir)/window_events.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/window_events.node
